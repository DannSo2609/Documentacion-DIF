# Documentación del Plugin DC_Notificacion_Aduana
...
El plugin `DC_Notificacion_Aduana` automatiza el envío de notificaciones a usuarios o equipos responsables cuando se les asigna un registro de Aduana en Dynacorp. Su objetivo es garantizar que los responsables reciban una alerta inmediata y personalizada, facilitando el seguimiento y gestión de registros aduaneros de manera eficiente.

---

## Propósito

- Notificar automáticamente a los responsables (usuarios o equipos) cuando se les asigna un registro de Aduana.
- Mejorar la trazabilidad y el seguimiento de asignaciones en procesos aduaneros.
...
- Extrae el campo `ownerid` del registro de Aduana para identificar si el responsable es un usuario individual o un equipo.
...
- Incluye un enlace directo al registro de Aduana asignado y un ícono personalizado para la notificación.
...
- **Automatización:** Elimina la necesidad de notificaciones manuales al asignar registros de Aduana.
...
- **Asignación de registros aduaneros:** Cuando se asigna un registro de Aduana a un usuario o equipo, estos reciben una notificación automatizada para iniciar el seguimiento.
...
- **Mejora de la eficiencia operativa:** Asegura que nadie quede sin ser notificado ante la asignación de tareas críticas.
...
El plugin `DC_Notificacion_Aduana` es esencial para la gestión eficiente de asignaciones y la comunicación interna en Dynacorp, asegurando que usuarios y equipos sean notificados de manera oportuna y personalizada ante nuevas responsabilidades en registros aduaneros.